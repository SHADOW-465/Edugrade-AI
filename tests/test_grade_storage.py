"""
Unit tests for Grade Storage Agent
"""
...
from agents.grade_storage import GradeStorageAgent, GradeRecord
...
class TestGradeStorageAgent:
    ...
    def test_initialization(self):
        ...
        assert self.agent.db_path == self.temp_db.name
    ...
    def test_store_grade_success(self):
        ...
        assert len(grade_record.current_hash) == 64
        assert grade_record.previous_hash == "0" * 64  # Genesis hash
    ...
    def test_get_exam_analytics(self):
        ...
        for i in range(5):
            self.agent.store_grade(
                ...
                score=70.0 + i * 5,  # Scores: 70, 75, 80, 85, 90
                max_score=100.0,
                percentage=70.0 + i * 5,
        ...
        assert analytics['average_percentage'] == 80.0  # (70+75+80+85+90)/5
    ...
    def test_error_handling_database_error(self):
        ...
        if hasattr(self.agent, '_connection'):
            self.agent._connection.close()
